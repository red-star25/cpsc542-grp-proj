...
(async function loginFormTest() {
  ...
  try {
    ...
    // Optionally, wait for a response or check for a success message
    await driver.wait(until.elementLocated(By.css(".success-message")), 10000); // Adjust selector as necessary
  } finally {
    await driver.quit();
  }
})();
