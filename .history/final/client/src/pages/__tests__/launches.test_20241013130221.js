...
(async function example() {
    ...
    try {
        ...
        let loadingMoreMessage = await driver.findElement(By.className('loading')).getText();
        expect(loadingMoreMessage).toEqual('Loading');

        // Assert that the additional launch tiles are displayed
        let additionalLaunchTiles = await driver.findElements(By.className('launch-tile'));
