...
(async function profileFormTest() {
  ...
  await login(driver);
  try {
    // click on profile button and navigate to profile page
    await driver.wait(until.elementLocated(By.css("button")), TIMEOUT);
    const profileButton = await driver.findElement(By.css("button"));
